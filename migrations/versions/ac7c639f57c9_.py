...
Revision ID: ac7c639f57c9
Revises: 
Create Date: 2022-07-31 04:05:56.176027
...
def upgrade():
    ...
    sa.Column('users', sa.String(length=250), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('planets', sa.String(length=80), nullable=True),
